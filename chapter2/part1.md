...
``Format()`` | Статический метод, формирует строку из других данных
...
``Split()`` | Возвращает длину строки
``Trim()`` | Возвращает длину строки
``ToUpper()`` | Возвращает длину строки
``ToLower()`` | Возвращает длину строки
